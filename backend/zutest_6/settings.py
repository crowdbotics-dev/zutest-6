"""
Django settings for zutest_6 project.
...
WSGI_APPLICATION = 'zutest_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "zutest_6 API",
    "DESCRIPTION": "API documentation for zutest_6 App",
    "VERSION": "v1",
}
